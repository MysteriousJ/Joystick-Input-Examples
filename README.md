...
### XBox controllers
If you really don't like the XInput API, it's possible to work with XBox controllers without it. XBox 360 controllers use [XUSB protocol](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-xusbi/c79474e7-3968-43d1-8d2f-175d47bef43e) and XBox One controllers use [Game Input protocol](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-gipusb/e7c90904-5e21-426e-b9ad-d82adeee0dbc) (GIP).

[Mārtiņš Možeiko has an excellent example program](https://gist.github.com/mmozeiko/b8ccc54037a5eaf35432396feabbe435) that uses file I/O for XUSB instead of the XInput API, and [Dave Madison has a great walkthrough of using Wireshark](https://www.partsnotincluded.com/understanding-the-xbox-360-wired-controllers-usb-data/) to reverse engineer the data needed. TheNathannator wrote a walkthrough that breaks down [how to use the GIP interface](https://gist.github.com/TheNathannator/bcebc77e653f71e77634144940871596).
